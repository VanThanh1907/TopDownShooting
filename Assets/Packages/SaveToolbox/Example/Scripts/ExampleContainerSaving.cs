...
namespace SaveToolbox.Example.Scripts
{
	public class ExampleContainerSaving : SaveableMonoBehaviour
	{
		...
		[SerializeField]
		private HashSet<int> intHashSet = new HashSet<int>();

		[SerializeField]
		private HashSet<string> stringHashSet = new HashSet<string>();

		[SerializeField]
		private Dictionary<int, int> intDictionary = new Dictionary<int, int>();
		...
		protected override void Awake()
		{
			...
			stringHashSet.Add("One HashSet");
			stringHashSet.Add("Two HashSet");
			stringHashSet.Add("Three HashSet");

			intDictionary.Add(1, 1);
			intDictionary.Add(2, 2);
			intDictionary.Add(3, 3);

			stringDictionary.Add(1, "One Dictionary");
			stringDictionary.Add(2, "Two Dictionary");
			stringDictionary.Add(3, "Three Dictionary");
		}
		...
		public override object Serialize()
		{
			...
			dataContainer.AddKeyValueEntry("exampleIntHashSet", intHashSet);
			dataContainer.AddKeyValueEntry("exampleStringHashSet", stringHashSet);
			dataContainer.AddKeyValueEntry("exampleIntDictionary", intDictionary);
			dataContainer.AddKeyValueEntry("exampleStringDictionary", stringDictionary);
		...
		public override void Deserialize(object data)
		{
			...
			intHashSet = dataContainer.GetValue<HashSet<int>>("exampleIntHashSet");
			stringHashSet = dataContainer.GetValue<HashSet<string>>("exampleStringHashSet");
			intDictionary = dataContainer.GetValue<Dictionary<int, int>>("exampleIntDictionary");
			stringDictionary = dataContainer.GetValue<Dictionary<int, string>>("exampleStringDictionary");
		}
