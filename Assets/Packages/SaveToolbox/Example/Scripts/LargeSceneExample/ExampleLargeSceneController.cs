...
#pragma warning restore CS4014
		...
		private void ResetState()
		{
			...
			var loadableObjects = FindObjectsByType<LoadableObject>(FindObjectsInactive.Include, FindObjectsSortMode.None);
#else
			var loadableObjects = FindObjectsOfType<LoadableObject>(true);
#endif
