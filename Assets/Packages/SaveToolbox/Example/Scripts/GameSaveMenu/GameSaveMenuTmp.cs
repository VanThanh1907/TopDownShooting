...
namespace SaveToolbox.Example.Scripts.GameSaveMenu
{
	...
	/// </summary>
	public class GameSaveMenuTmp : MonoBehaviour
	{
#if STB_HAS_TMP
		[SerializeField]
		...
		[SerializeField]
		private GameSaveLoadButtonTmp loadButtonPrefab;
			...
			void SaveData()
		{
			...
			var metaData = new BasicGameMetaData(slotIndex, inputField.text, DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss"), saveVersion);
...
#pragma warning restore CS4014
		...
		private void UpdateState()
		{
			...
			for (var i = loadButtonsParent.childCount - 1; i >= 0; i--)
			{
				...
				if (child.TryGetComponent<GameSaveLoadButtonTmp>(out var gameSaveLoadButton))
				{
