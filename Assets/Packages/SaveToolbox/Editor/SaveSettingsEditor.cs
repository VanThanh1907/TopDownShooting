...
namespace SaveToolbox.Editor
{
	...
	public class SaveSettingsEditor : UnityEditor.Editor
	{
		...
		private GUIContent useAddressablesContent;
#endif
...
#if STB_HAS_ADDRESSABLES
			if (useAddressablesContent == null)
			{
				useAddressablesContent = new GUIContent("Use Addressables:", "Should the project use addressables rather than Resources to load objects such as the loadable object database.");
			}
#endif
		}
		...
		public override void OnInspectorGUI()
		{
			...
			// Addressables.
#if STB_HAS_ADDRESSABLES
			saveSettingsSingleton.UseAddressables = EditorGUILayout.Toggle(useAddressablesContent, saveSettingsSingleton.UseAddressables);
#endif
			...
			if (GUILayout.Button("Reset Serialization Settings"))
			{
